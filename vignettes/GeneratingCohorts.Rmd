...
```{r, results='hide', error=FALSE, warning=FALSE, message=FALSE}
# First get the cohort table names to use for this generation task
cohortTableNames <- CohortGenerator::getCohortTableNames(cohortTable = "stats_example")
...
cohortTableNames <- CohortGenerator::getCohortTableNames(cohortTable = "incremental_example")
CohortGenerator::createCohortTables(connectionDetails = connectionDetails,
                                    cohortTableNames = cohortTableNames,
                                    cohortDatabaseSchema = "main",
                                    createCohortStatsTables = TRUE,
